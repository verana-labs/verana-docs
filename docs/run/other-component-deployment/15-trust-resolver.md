...
- **Deterministic view of ecosystems.** Because it subscribes to the chain, it can answer “what did this ecosystem look like at block X?”—a requirement for compliance and audits.

## High-level architecture

1. **Ingestion:** Workers subscribe to the indexer’s event bus (or Kafka/Postgres listeners) and verifiable-service updates.
