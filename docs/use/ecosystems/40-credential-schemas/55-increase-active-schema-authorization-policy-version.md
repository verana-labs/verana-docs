...
3. An **operator** granted authorization for `/verana.cs.v1.MsgIncreaseActiveSchemaAuthorizationPolicyVersion` via [Grant Operator Authorization](../../corporation/delegation/grant-operator-authorization).
