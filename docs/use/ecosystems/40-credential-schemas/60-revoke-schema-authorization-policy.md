...
3. An **operator** granted authorization for `/verana.cs.v1.MsgRevokeSchemaAuthorizationPolicy` via [Grant Operator Authorization](../../corporation/delegation/grant-operator-authorization).
